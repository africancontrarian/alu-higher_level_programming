...
class Student:
    ...
    def reload_from_json(self, json):
        """Replace all of this Student's attributes with the
        key/value pairs found in a dictionary.

        Args:
            json (dict): A dictionary whose keys are attribute
                names and whose values are the new attribute
                values.
        """
